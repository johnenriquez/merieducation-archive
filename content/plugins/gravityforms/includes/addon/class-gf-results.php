				...
				<h2 class="gf_admin_page_title">
					<span><?php echo empty( $form_id ) ? $page_title : $page_title . ' : ' . esc_html( $form['title'] ) ?></span><span
						class="gf_admin_page_subtitle"><span
							...
							class="gf_admin_page_formname"><?php esc_html_e( 'Form Name', 'gravityforms' ) ?>
				...
				<?php if ( false === empty( $all_fields ) ) : ?>
									...
									<form id="gresults-results-filter-form" action="" method="GET">
										...
										<div id="gresults-results-filter-buttons">
											...
											<div class="gresults-filter-loading"
												...
												<i class='gficon-gravityforms-spinner-icon gficon-spin'></i> <?php esc_html_e( 'Loading', 'gravityforms' ); ?>
											</div>
										</div>
									</form>
								</div>
					...
					<div class="gresults-filter-loading" style="display:none;margin:0 5px 10px 0;">
						...
						<a href="javascript:void(0);"
						   onclick="javascript:gresultsAjaxRequest.abort()"><?php esc_html_e( 'Cancel', 'gravityforms' ); ?></a>
					</div>
